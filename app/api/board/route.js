...
export async function POST(req) {
    try {
        // First, we validate the request body to ensure the board name is provided
        // Then, we check the session to confirm the user is authenticated
